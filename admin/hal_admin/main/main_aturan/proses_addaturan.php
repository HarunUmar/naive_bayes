...
if(isset($_POST['btnSimpan'])){
	...
	$cekSql="SELECT * FROM aturan WHERE kd_penyakit='$cmbPenyakit' AND kd_gejala='$cmbGejala'";
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "INSERT INTO aturan (kd_penyakit, kd_gejala, nilai_probabilitas) 
					VALUES ('$cmbPenyakit', '$cmbGejala', '$txtProbabilitas')";
